...
<!--       <?php echo $this->element('Medias/Medias/Preview', array('media'=>$product, 'config'=>array('name'=>false, 'description'=>false))); ?>  </td> -->
	...
	<input id="produced_<?php echo $shop['Shop']['id'].'_'.$product['Product']['id'] ?>" class="watch spinner" type="text" name="Sale[<?php echo $shop['Shop']['id']?>][<?php echo $product['Product']['id']?>][produced]" size="10" value="<?php echo $produced; ?>" /></td>
      <td class="sold"><input id="sold_<?php echo $shop['Shop']['id'].'_'.$product['Product']['id'] ?>" class="watch spinner" type="text" name="Sale[<?php echo $shop['Shop']['id']?>][<?php echo $product['Product']['id']?>][sold]" size="10" value="<?php echo $sold; ?>"  /></td>
