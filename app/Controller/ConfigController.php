...
//         }
	...
	$i++;
		...
		// add demo user
		$sql .= 'insert into '.$tablePrefix.'users (email, name, password, isRoot, company_id) values (\''.Configure::read('Settings.demo.User.email').'\', \'demo\', \''.AuthComponent::password(Configure::read('demo.User.password'))."', true, 1);\n";
